...
let DATABASE = localStorage.getItem("DATABASE")
  ...
  : {
      ...
      ACCOUNTS: [
        ...
        {
          ID: generateUUIDV4(),
          username: "Nguyễn Thái Duy",
          phoneNumber: "0123456789",
          address: "Số 1 phố Xốm, Hà Đông, Hà Nội",
  ...
  let contents = `
        <div class="card" style="width: 18rem;" data-aos="fade-left">
            ...
            <div class="card-body">
                ...
                <button class="btn btn-primary btn-sm" id="addCart" data-code="${
                  product.code
  ...
  products.forEach((p) => {
    contents += `
        <tr>
            ...
            <td>
                <i class="fas fa-minus-circle text-secondary" id="minus" data-code="${
                  p.code
                }"></i>
                <input type="text" value="${
                  p.quantity
                }" min="1" style="width: 35px; padding-left: 8px;" disabled />
                <i class="fas fa-plus-circle text-success" id="plus" data-code="${
                  p.code
                }"></i>
            </td>
            <td>${formatter.format(p.price * p.quantity)}</td>
            <td>
                <i class="fas fa-times text-danger" id="remove" data-code="${
                  p.code
                }"></i>
            </td>
        </tr> `;
